window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		var SessionProgressBar_module_css_default = {
			"tokenRow": "Jn-3TW_tokenRow",
			"rate": "Jn-3TW_rate",
			"glyph": "Jn-3TW_glyph",
			"fillRunning": "Jn-3TW_fillRunning",
			"fill": "Jn-3TW_fill",
			"dsh-session-progress-glow": "Jn-3TW_dsh-session-progress-glow",
			"dsh-session-progress-background-glow": "Jn-3TW_dsh-session-progress-background-glow",
			"eta": "Jn-3TW_eta",
			...
			"tokenChip": "Jn-3TW_tokenChip",
			"tokenHead": "Jn-3TW_tokenHead",
			"tokenValue": "Jn-3TW_tokenValue",
			"shimmer": "Jn-3TW_shimmer",
			"tokenPanel": "Jn-3TW_tokenPanel",
			"bar": "Jn-3TW_bar",
		...
		*/
		function subagentRunningCount(byId, rootId) {
		...
		*/
		function SessionProgressBar({ session, sessionId, t, useConversation, useProjection, useSessions, useSessionPendingInteraction }) {
			...
			const tokenTotals = usage === void 0 ? null : {
				total: billedInput + usage.outputTokens,
			...
			const [tokenPinned, setTokenPinned] = (0, react.useState)(false);
			const [tokenHover, setTokenHover] = (0, react.useState)(false);
			const tokenHoverTimer = (0, react.useRef)(void 0);
			/** Schedule the hover preview to close; the panel or chip re-enter cancels. */
			const scheduleTokenHide = () => {
				tokenHoverTimer.current = window.setTimeout(() => {
					setTokenHover(false);
				}, 120);
			};
			/** Cancel a scheduled hover close (pointer moved onto the panel/chip). */
			const cancelTokenHide = () => {
				if (tokenHoverTimer.current !== void 0) {
					window.clearTimeout(tokenHoverTimer.current);
					tokenHoverTimer.current = void 0;
				}
			};
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: clsx(SessionProgressBar_module_css_default.glyph, (running || background) && SessionProgressBar_module_css_default.glyphRunning),
							children: running || background ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconLoadingOutline16, { size: 14 }) : interrupted ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconWarningOutline16, { size: 14 }) : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconSparkle16, { size: 14 })
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: SessionProgressBar_module_css_default.label,
							children: pending ? pendingLabel(ownPending, subPending, t) : interrupted ? t("bar.interrupted") : background ? t("bar.background", { count: subRunning }) : stateLabel(running, toolName, thinking, counts, t)
						}),
						...
						tokenTotals !== null && tokenTotals.total > 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
							type: "button",
							className: SessionProgressBar_module_css_default.tokenChip,
							"data-pin": tokenPinned ? "true" : void 0,
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(_deepseek_ai_dsh_client_ui_primitives.IconDatabaseOutline16, { size: 12 }), formatTokenCount(tokenTotals.total)]
						})
					]
				}), tokenTotals !== null && tokenTotals.total > 0 && tokenPanelOpen && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					className: SessionProgressBar_module_css_default.tokenPanel,
					role: "dialog",
					"aria-label": t("token.total"),
					onMouseEnter: () => {
						cancelTokenHide();
					},
					onMouseLeave: () => {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: SessionProgressBar_module_css_default.tokenRow,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: SessionProgressBar_module_css_default.tokenHead,
								children: t("token.total")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: SessionProgressBar_module_css_default.tokenValue,
								children: [tokenTotals.total.toLocaleString("en-US"), " tok"]
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: SessionProgressBar_module_css_default.tokenRow,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("token.uncached") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: SessionProgressBar_module_css_default.tokenValue,
								children: [tokenTotals.uncached.toLocaleString("en-US"), " tok"]
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: SessionProgressBar_module_css_default.tokenRow,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("token.cacheRead") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: SessionProgressBar_module_css_default.tokenValue,
								children: [tokenTotals.cacheRead.toLocaleString("en-US"), " tok"]
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: SessionProgressBar_module_css_default.tokenRow,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("token.cacheWrite") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: SessionProgressBar_module_css_default.tokenValue,
								children: [tokenTotals.cacheWrite.toLocaleString("en-US"), " tok"]
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: SessionProgressBar_module_css_default.tokenRow,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("token.output") }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
								className: SessionProgressBar_module_css_default.tokenValue,
								children: [tokenTotals.output.toLocaleString("en-US"), " tok"]
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							className: SessionProgressBar_module_css_default.tokenRow,
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("token.cacheHit") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								className: SessionProgressBar_module_css_default.tokenValue,
								children: tokenTotals.billedInput > 0 ? Math.round(tokenTotals.cacheRead / tokenTotals.billedInput * 100) + "%" : "—"
							})]
						})
					]
				})]
